...
Data registration and usage boundaries [source:SOURCE-REGISTRY]: 7 items of formal available data, 1 item of background data, and 1 item of provisional-only data. `data/processed/agent_fact_pack.md` serves as a reading navigation layer and is not a new authoritative source [source:PROCESSED-FACT-PACK].
